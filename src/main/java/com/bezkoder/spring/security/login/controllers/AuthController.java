...
import com.bezkoder.spring.security.login.dto.response.JwtResponse;
...
import com.bezkoder.spring.security.login.dto.request.LoginRequest;
import com.bezkoder.spring.security.login.dto.request.SignupRequest;
import com.bezkoder.spring.security.login.dto.response.MessageResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok(new JwtResponse(
                "Bearer " + jwt, // Important: prefix with Bearer
                userDetails.getId(),
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        System.out.println("DEBUG: " + signUpRequest);
//    assert false : "Intentional stop during debug";
        ...
        EUserLanguage userLang = signUpRequest.getLanguage() != null ? signUpRequest.getLanguage() : EUserLanguage.EN;
